...
public class UploadActivity extends AppCompatActivity {
    ...
    public void saveData(){
        ...
        StorageReference storageReference = FirebaseStorage.getInstance().getReference().child("Oshi Images")
    ...
    public void uploadData(){
        ...
        FirebaseDatabase.getInstance().getReference("Oshi Data").child(title)
